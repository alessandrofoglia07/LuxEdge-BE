...
export const generateAccessToken = (user) => __awaiter(void 0, void 0, void 0, function* () {
    const token = jwt.sign({ userId: user._id, role: user.role }, process.env.ACCESS_TOKEN_SECRET, { expiresIn: '15m' });
    return token;
});
...
export const generateRefreshToken = (user) => __awaiter(void 0, void 0, void 0, function* () {
    const refreshToken = jwt.sign({ userId: user._id, role: user.role }, process.env.REFRESH_TOKEN_SECRET, { expiresIn: '30 days' });
    return refreshToken;
});
